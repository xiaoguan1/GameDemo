...
mysql -hlocalhost -uroot -proot $dbname << EOF 2>/dev/null
insert into server_config(cluster_no, server_id, node_name, ipport, jlogin_ipport, is_start_display, is_start_example, is_start_center) values
(1, 1, "user", "127.0.0.1:32526", "127.0.0.1:32525", 55001, 55001, 55001),
